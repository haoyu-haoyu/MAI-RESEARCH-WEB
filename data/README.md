...
- Edit `projects.json` to add or update projects, control card visibility with `hidden`, define legacy routes with `redirect`, and maintain optional project-detail content.
